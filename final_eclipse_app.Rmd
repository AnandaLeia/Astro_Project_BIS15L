...
```{r}
## Bare bones Dashboard shiny app (Date range doesn't work yet, but if you change it to selectInput and have the user input a year it does work)
...
ui <- dashboardPage(
  ...
  dashboardSidebar(title="Eclipse Selections", 
                   dateRangeInput("x", "Select Year", format = "yyyy"),
